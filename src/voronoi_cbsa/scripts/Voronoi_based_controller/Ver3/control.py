...
class PTZCamera():
    ...
    def RosInit(self):
        ...
        rospy.Subscriber(f"/vrpn_client_node/agent_{self.id}/pose", PoseStamped, self.PosCallback)
    ...
    def PosCallback(self, msg):
        """接收 OptiTrack 資訊，並平移座標"""
         
        x_optitrack = msg.pose.position.x
        y_optitrack = msg.pose.position.y

        
        self.tmp_pos[0] = x_optitrack + 1.5
        self.tmp_pos[1] = y_optitrack + 1.5
